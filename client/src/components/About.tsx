...
export const About: React.FC = () => {
  return (
    <section id="about" className="relative py-20 sm:py-28 bg-white text-[#0A0A0A] border-t border-slate-200 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 space-y-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          >
            <div className="inline-flex items-center space-x-2.5 px-3 py-1 bg-sky-50 border border-[#00A3FF]/30 rounded-full text-xs font-semibold tracking-widest text-[#00A3FF] uppercase">
            ...
            <h2 className="font-thunder text-4xl sm:text-6xl md:text-7xl font-extrabold text-[#0A0A0A] leading-tight">
              KARNATAKA'S PREMIER <span className="text-gradient">COASTAL MOVEMENT</span>
            </h2>
            ...
            <div className="space-y-4 text-base sm:text-lg text-slate-700 font-normal leading-relaxed">
              ...
              <p className="border-l-4 border-[#00A3FF] pl-4 italic text-slate-900 font-medium bg-sky-50/60 py-3">
            ...
            <div className="pt-4 grid grid-cols-2 sm:grid-cols-3 gap-6">
              ...
              <div className="border border-slate-200 bg-slate-50 p-4 shadow-sm col-span-2 sm:col-span-1">
          ...
          >
            <div className="relative p-1 bg-gradient-to-b from-[#00A3FF]/40 via-slate-200 to-white shadow-xl">
              <div className="bg-white p-8 sm:p-10 space-y-6">
                <div className="text-xs font-mono text-[#00A3FF] tracking-widest uppercase font-bold flex items-center justify-between">
                  <span>EVENT HIGHLIGHTS // DEC 2026</span>
                </div>
                <h3 className="font-thunder text-3xl sm:text-4xl text-[#0A0A0A] leading-tight flex items-center gap-2">
                  PADUKERE GROUND <ArrowRight className="w-6 h-6 text-[#00A3FF] inline flex-shrink-0" /> KAPU LIGHT HOUSE
                </h3>
