    ...
    <section id="details" className="py-20 sm:py-28 bg-white text-[#0A0A0A] border-t border-slate-200 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-14">
          <div className="bg-slate-50 border border-slate-200 p-8 sm:p-10 flex items-center justify-between shadow-sm">
            <div>
              ...
              <span className="text-sm text-slate-600 mt-1 block">Registered Coastal Marathoners</span>
            </div>
            <div className="w-16 h-16 bg-sky-100 border border-sky-200 rounded-none flex items-center justify-center">
          ...
          <div className="bg-slate-50 border border-slate-200 p-8 sm:p-10 flex items-center justify-between shadow-sm">
            <div>
              ...
              <span className="text-sm text-slate-600 mt-1 block">Cheering Community Members</span>
            </div>
            <div className="w-16 h-16 bg-sky-100 border border-sky-200 rounded-none flex items-center justify-center">
        ...
        <div className="bg-white border border-slate-200 p-8 shadow-md">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <div className="bg-slate-50 p-5 border-l-4 border-[#00A3FF] border border-slate-200">
              ...
              <p className="text-xs text-slate-800 font-semibold mt-1">Padukere Ground ➔ Padukare School Ground</p>
              <p className="text-[11px] text-slate-600">Kids & Senior Citizens Walk/Run</p>
              <span className="inline-block mt-3 px-2 py-0.5 bg-emerald-100 text-emerald-800 text-xs font-bold uppercase border border-emerald-300">
                FREE ENTRY
              </span>
            </div>
            ...
            <div className="bg-slate-50 p-5 border-l-4 border-[#00A3FF] border border-slate-200">
              ...
              <p className="text-[11px] text-slate-600">Fitness enthusiasts & beginners</p>
            ...
            <div className="bg-slate-50 p-5 border-l-4 border-[#00A3FF] border border-slate-200">
              ...
              <p className="text-[11px] text-slate-600">Timed distance challenge</p>
              <span className="inline-block mt-3 px-2 py-0.5 bg-sky-100 text-sky-800 text-xs font-bold uppercase border border-sky-300">
                ₹799 INR
              </span>
            </div>
            ...
            <div className="bg-slate-50 p-5 border-l-4 border-[#00A3FF] border border-slate-200">
              ...
              <p className="text-[11px] text-slate-600">Full 15K coastal marathon course</p>
              <span className="inline-block mt-3 px-2 py-0.5 bg-sky-100 text-sky-800 text-xs font-bold uppercase border border-sky-300">
                ₹999 INR
              </span>
            </div>
